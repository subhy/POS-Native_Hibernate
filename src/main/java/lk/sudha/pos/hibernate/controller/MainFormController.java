...
import static lk.sudha.pos.hibernate.db.HibernateUtil.*;
...
public class MainFormController implements Initializable {
    ...
    public void backupBtn_onAction(ActionEvent actionEvent) {
        ...
        if (file != null) {
            ...
            try {
                process = Runtime.getRuntime().exec("mysqldump -h" + getHost() + " -u" +getUsername() + " -p"
                        + getPassword() + " " + getDatabase() + " --result-file "
